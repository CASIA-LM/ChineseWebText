...
This directory contains the ChineseWebText dataset, and the EvalWeb tool-chain to process CommonCrawl Data for high-quality chinese data. Our ChineseWebText dataset is publicly available on https://huggingface.co/datasets/CASIA-LM/ChineseWebText.
